...
class KinesisEvent(YamlOrderedDict):
    ...
    def __init__(self, arn, batchSize=10, maximumRecordAgeInSeconds=120, startingPosition="LATEST",
...
class KinesisFunction(Function):
    ...
    def __init__(
        ...
        self.trigger(
            KinesisEvent(arn=stream, batchSize=batch_size, maximumRecordAgeInSeconds=maximum_record_age_in_seconds,
                         startingPosition=starting_position, functionResponseType=function_response_type))
