...
class Service(OrderedDict, yaml.YAMLObject):
    ...
    def render(self, output=None, attach_file_auto_generated_warning=True):
        if output:
            if attach_file_auto_generated_warning:
                output.write(self.warning_file_auto_generated)
        ...
        with open(Path(main.__file__).stem, "w+") as f:
            if attach_file_auto_generated_warning:
                f.write(self.warning_file_auto_generated)
            f.write(str(self))

    @property
    def warning_file_auto_generated(self):
        return "# DO NOT edit this file directly, it was generated based on serverless.py\n\n"
